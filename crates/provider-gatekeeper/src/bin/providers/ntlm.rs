...
use crate::utils::{
    enumerate_and_print_packages, hexdump,
...
pub fn main() {
    ...
    println!("  Client credentials acquired: {:#x}:{:#x}", client_cred.lower, client_cred.upper);
    ...
    println!("  Server credentials acquired: {:#x}:{:#x}", server_cred.lower, server_cred.upper);
